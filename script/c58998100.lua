...
function s.initial_effect(c) 
	...
	c:RegisterEffect(e2)
	--Apply Queen Ambrosé's effect, then add 1 "Horticopia" Spell or Trap from Deck
...
function s.fldflt(c)
	return c:IsSpellTrap() and c:IsSetCard(0x888) and c:IsAbleToHand()
end
function s.fldop(e,tp,eg,ep,ev,re,r,rp)
	...
	Duel.BreakEffect()
	--Add 1 "Horticopia" Spell or Trap from Deck
